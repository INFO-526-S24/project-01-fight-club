...
```{r }
#Question 1 Astronomical sightings bar chart.

library(ggplot2)
# Made a new dataframe df which has the number of sightings according to the day part.
setDT(ufo_sightings_enriched)
df <- ufo_sightings_enriched[, .(sightings = .N), day_part]
View(df)

# Now make a bar chart with the help of the df.
...
# Plot the data, bars in descending order by sightings
