...
-   SECOND QUESTION
    ...
    -   First, we will slice the \`reported_date_time_utc\` column, and separate the dates and times from it.

    -   Then we will clean data to handle all the various time zones and merge them accurately, which we have explained.
...
-   On the other hand, people in larger cities may not be able to clearly view these supposed “UFO sightings” due to various forms of pollution being more prevalent in these areas. But contrary to people in smaller cities, they may have the means to report the sightings quickly.

-   We believe that although this would introduce bad data in the data-set, there isn’t a suitable solution to address this issue.

-   But the shapes column in the ufo_sightings data-set can be a good way to filter out the data-sets, regardless of the location of the sightings.
